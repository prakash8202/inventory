package co.pointred.fx.comp.container
{
	...
	public class PrSkinnableContainer extends SkinnableContainer implements ICntnr
	{
		
		// key=Container Id, Value=PrUiContainer
		...
		public function PrSkinnableContainer()
		{
		...
		{
			// Title is not available for SkinnableContainer
			//  super.title=title;
		}
