package co.pointred.fx.comp.core
{
	...
	public class PrTextArea extends TextArea implements IComp
	{
		...
		public function doValidate():Boolean
		{
			...
			if(this.iValidator != null)
			{
				...
				if(false == this.validated)
				{
					this.validationErrMsg = this.iValidator.getValidationError().toString() + " in " + lblTxt;
					return this.validated;
				}
			}
			return this.validated;
